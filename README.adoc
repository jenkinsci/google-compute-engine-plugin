...
| Enable https://cloud.google.com/compute/shielded-vm/docs/shielded-vm[Shielded VM] (GCP docs) options (Secure Boot, vTPM, Integrity Monitoring). Optional; when omitted, the boot image's defaults apply. See <<shielded-vm,Shielded VM>>.
|===
...
Enable https://cloud.google.com/compute/shielded-vm/docs/shielded-vm[Shielded VM] (GCP docs) on the agent. Omit `shieldedVmConfiguration` to let the boot image's defaults apply.
