...
public class ComputeEngineCloudWindowsIT {
    ...
    /**
     *
     * @param publicKey Public Key to be put into the authorized_key file in our windows VM for SSH authentication
     * @return startupScript String startup script to run
     */
    private static String createStartupScript(String publicKey) {
        String startupScript = "$username = " + "\"" + WINDOWS_USER + "\"" + "\n" +
    ...
    private static InstanceConfiguration validInstanceConfiguration1() throws Exception{
        ...
        String startupScript = createStartupScript(publicKey);
