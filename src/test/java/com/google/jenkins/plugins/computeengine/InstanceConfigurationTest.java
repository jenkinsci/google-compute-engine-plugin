...
public class InstanceConfigurationTest {
  ...
  public void testConfigRoundtrip() throws Exception {
    ...
    ComputeEngineCloud gcp =
        new ComputeEngineCloud("test", PROJECT_ID, "testCredentialsId", "1", configs);
    ...
    r.assertEqualBeans(
        want,
        got,
        "namePrefix,region,zone,machineType,preemptible,minCpuPlatform,startupScript,bootDiskType,bootDiskSourceImageName,bootDiskSourceImageProject,bootDiskSizeGb,acceleratorConfiguration,networkConfiguration,externalAddress,networkTags,serviceAccountEmail");
  }
  ...
  public void testInstanceModel() {
    ...
    assert (i.getMetadata()
        ...
        .get(0)
        .getKey()
        .equals(InstanceConfiguration.METADATA_STARTUP_SCRIPT_KEY));
