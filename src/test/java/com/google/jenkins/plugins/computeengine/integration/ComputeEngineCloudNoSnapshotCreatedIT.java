...
public class ComputeEngineCloudNoSnapshotCreatedIT {
    ...
    public static void init() throws Exception {
        ...
        InstanceConfiguration instanceConfiguration = ITUtil.instanceConfigurationBuilder()
    ...
    public void testNoSnapshotCreatedInstanceStopping() {
        Awaitility.await().timeout(1, TimeUnit.MINUTES).until(() -> "STOPPING"
                .equals(client.getInstance(PROJECT_ID, ZONE, name).getStatus()));
    }
