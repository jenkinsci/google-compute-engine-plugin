...
public class MinimumInstanceCheckerRetentionTest {
    ...
    public void minInstances_aboveThreshold_notPreserve() {
        ...
        assertFalse(MinimumInstanceChecker.shouldPreserveAgent(2, 0, input, 0, true, true));
    }
    ...
    public void minSpare_notIdle_notPreserve() {
        ...
        var input = new MinCheckerInput(5, 2, 0, 0);
        assertFalse(MinimumInstanceChecker.shouldPreserveAgent(0, 2, input, 0, false, true));
    }
    ...
    public void minSpare_offline_notPreserve() {
        ...
        var input = new MinCheckerInput(5, 2, 0, 0);
        assertFalse(MinimumInstanceChecker.shouldPreserveAgent(0, 2, input, 0, true, false));
    }
    ...
    public void minSpare_aboveThreshold_notPreserve() {
        ...
        assertFalse(MinimumInstanceChecker.shouldPreserveAgent(0, 2, input, 0, true, true));
    }
    ...
    public void pendingTerminations_stillAboveThreshold_notPreserve() {
        ...
        assertFalse(MinimumInstanceChecker.shouldPreserveAgent(2, 0, input, 1, true, true));
    }
    ...
    public void neitherRequired_notPreserve() {
        ...
        var input = new MinCheckerInput(1, 1, 0, 0);
        assertFalse(MinimumInstanceChecker.shouldPreserveAgent(0, 0, input, 0, true, true));
    }
    ...
    public void bothChecks_minInstancesSatisfied_spareExceeded() {
        ...
        assertFalse(MinimumInstanceChecker.shouldPreserveAgent(2, 2, input, 0, true, true));
    }
}
