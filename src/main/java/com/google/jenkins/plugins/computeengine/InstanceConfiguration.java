...
public class InstanceConfiguration implements Describable<InstanceConfiguration> {
  ...
  public static final List<String> KNOWN_LINUX_IMAGE_PROJECTS =
  ...
  public ComputeEngineInstance provision(TaskListener listener, Label requiredLabel)
      throws IOException {
    ...
    try {
      ...
      ComputeEngineInstance instance =
  ...
  public static final class DescriptorImpl extends Descriptor<InstanceConfiguration> {
    ...
    public List<NetworkConfiguration.NetworkConfigurationDescriptor>
      ...
      List<NetworkConfiguration.NetworkConfigurationDescriptor> d =
          Jenkins.getInstance().getDescriptorList(NetworkConfiguration.class);
    ...
    public FormValidation doCheckBootDiskSizeGbStr(
      ...
      try {
        ...
        Image i =
            compute.getImage(
                ComputeClient.lastParam(projectId), ComputeClient.lastParam(imageName));
